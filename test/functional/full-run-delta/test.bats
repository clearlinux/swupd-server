...
@test "full run update creation with delta packs" {
  ...
  [[ 1 -eq $(grep '^filecount:	4$' $DIR/www/10/includes-list | wc -l) ]]
  [[ 1 -eq $(grep '^test-bundle	os-core$' $DIR/www/10/includes-list | wc -l) ]]
  ...
  [[ 1 -eq $(grep '^filecount:	8$' $DIR/www/20/includes-list | wc -l) ]]
  [[ 1 -eq $(grep '^test-bundle	os-core$' $DIR/www/20/includes-list | wc -l) ]]
  [[ 1 -eq $(grep '^test-bundle	included$' $DIR/www/20/includes-list | wc -l) ]]
  [[ 1 -eq $(grep '^test-bundle	included-two$' $DIR/www/20/includes-list | wc -l) ]]
  [[ 1 -eq $(grep '^test-bundle	included-nested$' $DIR/www/20/includes-list | wc -l) ]]
  [[ 1 -eq $(grep '^included	os-core' $DIR/www/20/includes-list | wc -l) ]]
  [[ 1 -eq $(grep '^included	included-nested' $DIR/www/20/includes-list | wc -l) ]]
  [[ 1 -eq $(grep '^included-two	os-core' $DIR/www/20/includes-list | wc -l) ]]
  [[ 1 -eq $(grep '^included-nested	os-core' $DIR/www/20/includes-list | wc -l) ]]
