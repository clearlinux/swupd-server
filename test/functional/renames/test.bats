...
setup() {
  ...
  # And the files have enough content so they are shown as different
  gen_file_plain_with_content 10 test-bundle "foo" "$(seq 100)"
  gen_file_plain_with_content 20 test-bundle "bar" "$(seq 100)"
}
