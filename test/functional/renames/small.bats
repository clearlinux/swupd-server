...
setup() {
  ...
  # Files are too small to be worth using bsdiff
  gen_file_plain_with_content 10 test-bundle "foo" "$(seq 10)"
  gen_file_plain_with_content 20 test-bundle "bar" "$(seq 10)"
}

@test "rename detection small files" {
  ...
  # Don't expect to see any renames
